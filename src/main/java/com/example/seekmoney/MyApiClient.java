...
public interface MyApiClient {
	...
	@Get(url = "https://tp.tofur.com/addons/shopro/seckill/orderList?type=1&page=1")
	String orderList(@Header("Token") String token);
...
//	String seckillListv2(@Header("Token") String token,@Var("pageNumber") int pageNumber);
	...
	@LogEnabled(logRequest = false, logResponseContent = false)
